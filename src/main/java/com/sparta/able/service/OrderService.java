...
import com.sparta.able.enums.ResponseMessage;
import com.sparta.able.enums.ResponseStatusCode;
...
import static com.sparta.able.enums.ResponseMessage.*;
import static com.sparta.able.enums.ResponseStatusCode.*;
...
public class OrderService {
    ...
    @Transactional
    public ResponseBodyDto addOrder(AddOrderReqDto request) {
        /*
        ...
        */
        ...
        AddOrderResDto addOrderResDto = AddOrderResDto.make(purchaseProduct.getName(), purchaseProduct.getPrice());
        return ResponseBodyDto.make(SUCCESS.getCode(), ORDER_COMPLETED.getMessage(), addOrderResDto);
    }
}
